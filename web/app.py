...
PATH_TO_LABELS = (
    '/output/models/research/object_detection/data/mscoco_label_map.pbtxt')
...
class ObjectDetector():
  ...
  def _build_graph(self):
    ...
    with detection_graph.as_default():
      ...
      with tf.gfile.GFile(
	     '/output/tensorflow_object_detection_api_demo/ssd_mobilenet_v1_coco_2017_11_17/frozen_inference_graph.pb',
          'rb') as fid:
